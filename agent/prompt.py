...
6. chart - Generate a Mermaid flowchart for the repository. this help the structure of the project which is usefull if user want to understand the project (requires 'repo_name')
7. self_solve - Tasks that can be solved without API calls (requires 'content')

Conversation history: {conversation_history}
Task goal: {goal}
By default if the action is search and the the suitable repository is found, the action will repo_tree.
